...
Some people argue that Anaconda takes too much space (~ 2GB) and you end up with too many packages you don’t need. Therefore, an alternative is Miniconda (which only includes conda, Python, and the packages they depend on) and then install each package you need separately.
